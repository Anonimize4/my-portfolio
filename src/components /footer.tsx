      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="space-y-4">
            <h3 className="text-xl font-bold text-blue-400">Portfolio</h3>
            <p className="text-gray-300 leading-relaxed">
              A passionate developer showcasing skills, projects, and professional journey in web development and software engineering.
            </p>
